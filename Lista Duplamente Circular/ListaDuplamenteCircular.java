public class ListaDuplamenteCircular {
	private NoLDC primeira = null;
	private NoLDC ultima = null;
	private int contador=0;
	
	public void Insere(Object elemento) {
		//insere no come�o da lista
		//TODO
		NoLDC novo = new NoLDC(elemento, this.primeira);
		this.primeira = novo;
		if (this.contador == 0) {
	...
	public void InsereF(Object elemento) {
		...
		if(this.contador == 0) {
			...
			NoLDC novo = new NoLDC(elemento,null);
